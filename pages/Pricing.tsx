    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-start overflow-y-auto font-['Poppins',sans-serif]">
            <div className="sticky top-0 w-full p-12 flex justify-between items-center z-50 bg-gradient-to-b from-white to-transparent">
                <button onClick={() => navigate('/')} className="text-zinc-900 font-black uppercase tracking-widest text-[10px] flex items-center gap-3 hover:gap-5 transition-all group">
